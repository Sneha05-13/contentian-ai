        ...
        <section className="py-16 lg:py-24 text-center">
          <div className="max-w-3xl mx-auto px-4">
            ...
            <p className="text-xl text-zinc-600 dark:text-zinc-400">
              Real experiments, lessons and honest experiences with AI.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="p-6 rounded-2xl bg-white dark:bg-zinc-900/50 border border-zinc-200/60 dark:border-white/10 shadow-sm hover:shadow-md transition-all">
                  ...
                  <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-2">{exp}</h3>
                  <p className="text-zinc-600 dark:text-zinc-400 text-sm">Read insights and lessons from our journey involving {exp.toLowerCase()}.</p>
                </div>
              ))}
            </div>
