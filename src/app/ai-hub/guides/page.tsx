...
import GuideCard from "@/components/ai-hub/GuideCard";
      ...
      <main className="flex-1">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
          <nav className="flex items-center text-sm text-zinc-500 dark:text-zinc-400 font-medium">
            ...
            <span className="text-zinc-900 dark:text-white">AI Guides</span>
          </nav>
        </div>
        ...
        <section className="py-16 lg:py-24 text-center">
          <div className="max-w-3xl mx-auto px-4">
            ...
            <p className="text-xl text-zinc-600 dark:text-zinc-400">
              Practical tutorials, workflows and step-by-step guides to help you get more from AI.
            </p>
          </div>
        </section>
