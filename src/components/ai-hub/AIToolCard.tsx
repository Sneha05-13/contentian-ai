...
export default function AIToolCard({ name, description, category, slug, pricing, featured }: AITool) {
  return (
    <Link href={`/ai-hub/tools/${slug}`} className="flex flex-col p-6 rounded-2xl bg-white dark:bg-zinc-900/50 border border-zinc-200/60 dark:border-white/10 shadow-sm hover:shadow-md dark:hover:shadow-[0_0_15px_rgba(99,102,241,0.1)] transition-all group h-full relative">
      {featured && (
